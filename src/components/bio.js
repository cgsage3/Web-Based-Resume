const Bio = ()=> (
            <div class="section row">
                ...
                <div class="section-text col-right row">
                	<div>
Highly skilled and experienced senior developer with 8+ years of expertise in designing and 
...
skills with a commitment to continuous learning and staying up-to-date with industry trends.</div>
                </div>
            </div>	
	);
export default Bio;